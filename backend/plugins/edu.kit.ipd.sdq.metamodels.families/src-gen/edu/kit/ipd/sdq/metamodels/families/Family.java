 ...
 *   <li>{@link edu.kit.ipd.sdq.metamodels.families.Family#getId <em>Id</em>}</li>
 * </ul>
 *
...
public interface Family extends EObject {
	 ...
	 * @see #setId(String)
	 * @see edu.kit.ipd.sdq.metamodels.families.FamiliesPackage#getFamily_Id()
	 * @model id="true"
	 * @generated
	 */
	String getId();
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.metamodels.families.Family#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
