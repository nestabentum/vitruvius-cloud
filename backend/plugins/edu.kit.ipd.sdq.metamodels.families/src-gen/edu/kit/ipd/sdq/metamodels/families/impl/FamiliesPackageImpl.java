...
public class FamiliesPackageImpl extends EPackageImpl implements FamiliesPackage {
	...
	public EAttribute getFamilyRegister_Id() {
		return (EAttribute)familyRegisterEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getMember_Id() {
	...
	public void createPackageContents() {
		...
		createEAttribute(memberEClass, MEMBER__ID);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMember_Id(), ecorePackage.getEString(), "id", null, 0, 1, Member.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
