...
public interface FamiliesPackage extends EPackage
{
	...
	/**
	 * The meta object id for the '{@link edu.kit.ipd.sdq.metamodels.families.impl.IdentifiableImpl <em>Identifiable</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see edu.kit.ipd.sdq.metamodels.families.impl.IdentifiableImpl
	 * @see edu.kit.ipd.sdq.metamodels.families.impl.FamiliesPackageImpl#getIdentifiable()
	 * @generated
	 */
	int IDENTIFIABLE = 3;
	 ...
	 * @ordered
	 */
	int FAMILY_REGISTER__ID = IDENTIFIABLE__ID;
	 ...
	 * @ordered
	 */
	int FAMILY_REGISTER__FAMILIES = IDENTIFIABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FAMILY_REGISTER__TEST = IDENTIFIABLE_FEATURE_COUNT + 1;

	/**
	 * The feature id for the '<em><b>Fam</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FAMILY_REGISTER__FAM = IDENTIFIABLE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FAMILY_REGISTER_FEATURE_COUNT = IDENTIFIABLE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int FAMILY_REGISTER_OPERATION_COUNT = IDENTIFIABLE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FAMILY__LAST_NAME = IDENTIFIABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FAMILY__SONS = IDENTIFIABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int FAMILY__DAUGHTERS = IDENTIFIABLE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FAMILY__FATHER = IDENTIFIABLE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int FAMILY__MOTHER = IDENTIFIABLE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int FAMILY_FEATURE_COUNT = IDENTIFIABLE_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int MEMBER__ID = IDENTIFIABLE__ID;
	 ...
	 * @ordered
	 */
	int MEMBER__FAMILY_SON = IDENTIFIABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MEMBER__FAMILY_DAUGHTER = IDENTIFIABLE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int MEMBER__FAMILY_FATHER = IDENTIFIABLE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int MEMBER__FAMILY_MOTHER = IDENTIFIABLE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int MEMBER_FEATURE_COUNT = IDENTIFIABLE_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int MEMBER_OPERATION_COUNT = IDENTIFIABLE_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the reference '{@link edu.kit.ipd.sdq.metamodels.families.FamilyRegister#getTest <em>Test</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Test</em>'.
	 * @see edu.kit.ipd.sdq.metamodels.families.FamilyRegister#getTest()
	 * @see #getFamilyRegister()
	 * @generated
	 */
	EReference getFamilyRegister_Test();

	/**
	 * Returns the meta object for the containment reference list '{@link edu.kit.ipd.sdq.metamodels.families.FamilyRegister#getFam <em>Fam</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Fam</em>'.
	 * @see edu.kit.ipd.sdq.metamodels.families.FamilyRegister#getFam()
	 * @see #getFamilyRegister()
	 * @generated
	 */
	EReference getFamilyRegister_Fam();
	...
	/**
	 * Returns the meta object for class '{@link edu.kit.ipd.sdq.metamodels.families.Identifiable <em>Identifiable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Identifiable</em>'.
	 * @see edu.kit.ipd.sdq.metamodels.families.Identifiable
	 * @generated
	 */
	EClass getIdentifiable();

	/**
	 * Returns the meta object for the attribute '{@link edu.kit.ipd.sdq.metamodels.families.Identifiable#getId <em>Id</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Id</em>'.
	 * @see edu.kit.ipd.sdq.metamodels.families.Identifiable#getId()
	 * @see #getIdentifiable()
	 * @generated
	 */
	...
	interface Literals
	{
		 ...
		 * @generated
		 */
		EReference FAMILY_REGISTER__TEST = eINSTANCE.getFamilyRegister_Test();

		/**
		 * The meta object literal for the '<em><b>Fam</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference FAMILY_REGISTER__FAM = eINSTANCE.getFamilyRegister_Fam();
		...
		/**
		 * The meta object literal for the '{@link edu.kit.ipd.sdq.metamodels.families.impl.IdentifiableImpl <em>Identifiable</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see edu.kit.ipd.sdq.metamodels.families.impl.IdentifiableImpl
		 * @see edu.kit.ipd.sdq.metamodels.families.impl.FamiliesPackageImpl#getIdentifiable()
