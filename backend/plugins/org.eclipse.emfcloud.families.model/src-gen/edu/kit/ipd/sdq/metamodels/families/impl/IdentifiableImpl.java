 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.metamodels.families.impl.IdentifiableImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifiableImpl extends MinimalEObjectImpl.Container implements Identifiable
{
	...
	{
		return FamiliesPackage.Literals.IDENTIFIABLE;
	}
	...
	public void setId(String newId)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.IDENTIFIABLE__ID, oldId, id));
	}
	...
	{
		switch (featureID) {
			case FamiliesPackage.IDENTIFIABLE__ID:
				return getId();
		}
