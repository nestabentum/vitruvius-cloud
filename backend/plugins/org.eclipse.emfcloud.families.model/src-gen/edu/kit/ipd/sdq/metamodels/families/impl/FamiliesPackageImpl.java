...
public class FamiliesPackageImpl extends EPackageImpl implements FamiliesPackage
{
	 ...
	 */
	@Override
	public EReference getFamilyRegister_Test()
	{
		return (EReference)familyRegisterEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getFamilyRegister_Fam()
	{
		return (EReference)familyRegisterEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents()
	{
		...
		createEReference(familyRegisterEClass, FAMILY_REGISTER__TEST);
		createEReference(familyRegisterEClass, FAMILY_REGISTER__FAM);
	...
	public void initializePackageContents()
	{
		...
		familyRegisterEClass.getESuperTypes().add(this.getIdentifiable());
		...
		initEReference(getFamilyRegister_Test(), this.getMember(), null, "test", null, 0, 1, FamilyRegister.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFamilyRegister_Fam(), this.getMember(), null, "fam", null, 0, -1, FamilyRegister.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
